# This is Brian's code from https://github.com/briandoconnor/my-sandbox/blob/92ee52fa9816593a23c8210eb7dd17cfebf4a9c1/20150520_analysis_for_EBI_runtimes/generate-stats.pl#L21
# modify it to take values from all projects to generate data for average download times and sizes per donor
use strict;
use JSON;
use Data::Dumper;
